...
void intro()
{
	...
	printf("\n---------------------------------------------------------\5INSTRUCTIONS\5-----------------------------------------------------------\n");
	printf("\4 THIS GAME CONSIST OF TWO PLAYERS->PLAYER1 AND PLAYER2.\n\4 PLAYER1 WRITE THE CODE WHICH IS UNKNOWN TO PLAYER2 NOW PLAYER TWO WILL HAVE 5 CHANCES TO GUESS THE CORRECT CODE\n\4IF PLAYER TWO GUESS THE CORRECT CODE IN 5 CHANCES THEN HE/SHE WILL WIN THE MATCH\n\4 IF PLAYER2 NOT ABLE TO FIND THE CODE IN 8 CHANCE THEN HE/SHE WILL LOSE THE GAME.\n");
